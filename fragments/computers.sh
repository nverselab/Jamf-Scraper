...
echo "Computer Name,Serial Number,Model,User,Department,Building,Room,OS Version,Enrolled Via DEP,MDM Capable,Last Check-In Time,Site,Group Memberships" > $outputDirectory/Reports/computers_$current_date.csv
...
for id in $computer_ids; do
	...
	echo "$computer_name,$serial_number,$model,$user,$department,$building,$room,$os_version,$enrolled_via_dep,$mdm_capable,$checkin_time,$site,$computer_groups" >> $outputDirectory/Reports/computers_$current_date.csv
